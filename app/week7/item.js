...
function Item({ name, quantity, category, onSelect }) {
    return (
        <li onClick={onSelect} className="flex items-center justify-between p-4 border-b-2 border-gray-200 bg-white hover:bg-gray-100 transition ease-in-out duration-150">
